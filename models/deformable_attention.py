"""
Multi-Scale Deformable Attention Module and Autograd Functions.
Pure PyTorch implementation with seamless CUDA fallback support.
"""
...
def ms_deform_attn_core_pytorch(value, value_spatial_shapes, sampling_locations, attention_weights):
    """
    Pure PyTorch fallback implementation of multi-scale deformable attention.
    """
...
class MSDeformAttnFunction(Function):
    ...
    def backward(ctx, grad_output):
        ...
        if MSDA is not None and value.is_cuda:
            ...
            raise NotImplementedError("Gradient backward is only supported with compiled CUDA extension.")
